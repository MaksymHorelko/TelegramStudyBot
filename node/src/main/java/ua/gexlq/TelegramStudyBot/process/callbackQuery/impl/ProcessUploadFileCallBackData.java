...
import ua.gexlq.TelegramStudyBot.keyboard.inline.pages.UploadRulesPage;
...
public class ProcessUploadFileCallBackData implements ProcessCallBackDataByState {
	...
	private final UploadRulesPage rulesPage;
	...
	public EditMessageText handle(Update update) {
		...
		response.setReplyMarkup(rulesPage.createUploadRulesPage(language));
