...
import ua.gexlq.TelegramStudyBot.keyboard.inline.pages.RateImplPage;
...
public class ProcessRateContentCallBackData implements ProcessCallBackDataByState {
	...
	private final RateImplPage rateImplPage;
	...
	public EditMessageText handle(Update update) {
		...
		upcomingDocument.setRateContent(rateContent);
		...
		response.setReplyMarkup(rateImplPage.createRateImplementationPage());
